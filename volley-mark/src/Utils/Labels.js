const labels = {
  EN: {
    ...
    max_substitutions: "Max Substitutions per Set",
    manage_team: "Manage Team",
    used_time_outs: "Used Time Outs",
    used_substitutions: "Used Substitutions",
    player_substitution: "Player Substitution",
    players_on_court: "Players on Court",
    available_players: "Available Players",
    add_new_player: "Add New Player",
    player_name: "Player name",
    select_player_to_substitute: "Please select a player to substitute",
    select_both_players: "Please select both players",
    ...
    team_reached_max_substitutions: "This team has reached the max substitutions allowed",
  ...
  SPN: {
    ...
    max_substitutions: "Cambios Maximos por Set",
    manage_team: "Administrar Equipo",
    used_time_outs: "Tiempos Usados",
    used_substitutions: "Cambios Usados",
    player_substitution: "Cambio de Jugador",
    players_on_court: "Jugadores en Cancha",
    available_players: "Jugadores Disponibles",
    add_new_player: "Agregar Nuevo Jugador",
    player_name: "Nombre del jugador",
    select_player_to_substitute: "Por favor selecciona un jugador para cambiar",
    select_both_players: "Por favor selecciona ambos jugadores",
    confirm_substitution: "Confirmar Cambio",
    add: "Agregar",
    cancel: "Cancelar",
    close: "Cerrar",
    save: "Guardar",
    ...
    team_reached_max_substitutions: "El equipo ha alcanzado la cantidad maxima de cambios permitidos",
